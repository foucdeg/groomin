...
import { Game, GamePhase, Pad } from 'redux/Story/types';
import { selectPlayerIsAdmin, selectRoom } from 'redux/Room/selectors';
import { selectGame, selectSelectedPadUuid } from 'redux/Story/selectors';
import { FormattedMessage } from 'react-intl';
import { useForceState, useReviewPad } from 'redux/Story/hooks';
import { selectAvailableVoteCount } from 'redux/Story/selectors';

import { tabHandlerBuilder } from 'services/utils';
import { selectPlayerId } from 'redux/Player/selectors';
import Loader from 'atoms/Loader';
import { useDispatch } from 'react-redux';
import { setSelectedPadUuid } from 'redux/Story';
