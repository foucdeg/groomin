"""
Django settings for groomin project.
...
MIDDLEWARE = [
    ...
    "groomin.sentry.RequestIdMiddleware",
]

ROOT_URLCONF = "groomin.urls"
...
WSGI_APPLICATION = "groomin.wsgi.application"
ASGI_APPLICATION = "groomin.routing.application"
